...
#endif // Done to be able to fold in the calls lol
...
{   
    ...
    *  exception_message[interrupt_number] */
    ...
    if (r->int_no < 32)
    {
        /* Display the description for the Exception that occurred and halt system */
        kprint(exception_messages[r->int_no], PANIC);
        kprint(" Exception\n", PANIC);
        for (;;);
    }
}